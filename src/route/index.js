...
// Route hooks for authentication and token validation
router.beforeEach((to, from, next) => {
    // Cancel pending requests from previous page when route changes
    clearPending();
    next();
})
...
// Handle duplicate route navigation errors
