      ...
      <div class="m-form__content">
        <div class="m-form__section">
          <dl>
            ...
            <dd>
              <m-input type="text" prop="name" labelWidth="100px" label="Name" v-model="name" required validateEvent
                @validate="validate" :show-error="rules.name.error" :error-msg="rules.name.message"
